...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between available models. Applies to this session and future Neko Code sessions. For other or previous model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
