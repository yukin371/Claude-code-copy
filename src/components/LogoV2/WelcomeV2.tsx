...
export function WelcomeV2() {
  ...
  if (env.terminal === "Apple_Terminal") {
    let t0;
    if ($[0] !== theme) {
      t0 = <AppleTerminalWelcomeV2 theme={theme} welcomeMessage="Welcome to Neko Code" />;
      $[0] = theme;
      $[1] = t0;
    } else {
      t0 = $[1];
  ...
  if (["light", "light-daltonized", "light-ansi"].includes(theme)) {
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
      t0 = <Text><Text color="claude">{"Welcome to Neko Code"} </Text><Text dimColor={true}>v{MACRO.VERSION} </Text></Text>;
      t1 = <Text>{"\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026"}</Text>;
      t2 = <Text>{"                                                          "}</Text>;
      t3 = <Text>{"                                                          "}</Text>;
      t4 = <Text>{"                                                          "}</Text>;
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
      t13 = <Text>{"      "}<Text color="clawd_background" backgroundColor="clawd_fill">◟  ◕   ◕  ◞</Text>{"                           \u2592\u2592         \u2592\u2592 "}</Text>;
      $[15] = t13;
    } else {
      t13 = $[15];
    }
    ...
    if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
      t14 = <Text>{"      "}<Text backgroundColor="clawd_fill">{"  "}<Text color="clawd_background">{"╲"}</Text>{"  "}<Text color="subtle">{"◡"}</Text>{"  "}<Text color="clawd_background">{"╱"}</Text>{"  "}</Text>{"                          \u2591          \u2592   "}</Text>;
      $[16] = t14;
    } else {
      t14 = $[16];
    }
  ...
  if ($[32] === Symbol.for("react.memo_cache_sentinel")) {
    t14 = <Text>{"      "}<Text color="clawd_background" backgroundColor="clawd_fill">◟  ◕   ◕  ◞</Text><Text>{"                        "}</Text><Text bold={true}>*</Text><Text>{"                "}</Text></Text>;
    $[32] = t14;
  } else {
    t14 = $[32];
  }
  ...
  if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
    t15 = <Text>{"      "}<Text backgroundColor="clawd_fill">{"  "}<Text color="clawd_background">{"╲"}</Text>{"  "}<Text color="subtle">{"◡"}</Text>{"  "}<Text color="clawd_background">{"╱"}</Text>{"  "}</Text>{"     *                                   "}</Text>;
    $[33] = t15;
  } else {
    t15 = $[33];
  }
...
function AppleTerminalWelcomeV2(t0) {
  ...
  if (isLightTheme) {
    ...
    let t16;
    if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
      t16 = <Text>{"      "}<Text color="clawd_background" backgroundColor="clawd_fill">◟  ◕   ◕  ◞</Text>{"                           \u2592\u2592         \u2592\u2592 "}</Text>;
      $[17] = t16;
    } else {
      t16 = $[17];
    }
    let t17;
    if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
      t17 = <Text>{"      "}<Text backgroundColor="clawd_fill">{"  "}<Text color="clawd_background">{"╲"}</Text>{"  "}<Text color="subtle">{"◡"}</Text>{"  "}<Text color="clawd_background">{"╱"}</Text>{"  "}</Text>{"                          \u2591          \u2592   "}</Text>;
      $[18] = t17;
    } else {
      t17 = $[18];
    }
  ...
  if ($[38] === Symbol.for("react.memo_cache_sentinel")) {
    t15 = <Text>{"      "}<Text color="clawd_body">{" ╭◜     ◝╮ "}</Text>{"                                       "}<Text dimColor={true}>*</Text><Text> </Text></Text>;
    $[38] = t15;
  } else {
    t15 = $[38];
  }
  ...
  if ($[39] === Symbol.for("react.memo_cache_sentinel")) {
    t16 = <Text>{"      "}<Text color="clawd_background" backgroundColor="clawd_fill">◟  ◕   ◕  ◞</Text><Text>{"                        "}</Text><Text bold={true}>*</Text><Text>{"                "}</Text></Text>;
    $[39] = t16;
  } else {
    t16 = $[39];
  }
