...
const DEFAULT_PREFIX = `You are Neko Code, a multi-provider AI coding CLI.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Neko Code, a multi-provider AI coding CLI, running within the Claude Agent SDK.`
