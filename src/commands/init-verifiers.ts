...
**All verifier skills are created in the project root's \`.neko-code/skills/\` directory.** This ensures they are automatically loaded when Neko runs in the project.

Write the skill file to \`.neko-code/skills/<verifier-name>/SKILL.md\`.
...
1. Where each skill was created (always in \`.neko-code/skills/\`)
